...
namespace tmx
{
    ...
    from a *.tmx format tile renderable_map via the tmx::Map
    class.
    */
    ...
    public:
        ...
        */
        ...
        method you choose to render the renderable_map.
        */
        ...
        /*!
        \brief Returns the colour used by the tile renderable_map image to represent transparency.
