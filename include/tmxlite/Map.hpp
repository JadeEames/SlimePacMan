...
{
    /*!
    \brief Holds the xml version of the loaded renderable_map
    */
    ...
    with the Tiled renderable_map editor, providing an interface to create drawable and
    ...
    */
    ...
    public:
        ...
        \param std::string Path to renderable_map file to try to parse
        \returns true if renderable_map was parsed successfully else returns false.
        In debug mode this will attempt to log any errors to the console.
        */
        bool load(const std::string&);

        /*!
        \brief Loads a renderable_map from a document stored in a string
        \param data A std::string containing the renderable_map data to load
        ...
        */
        ...
        /*!
        \brief Returns the version of the tile renderable_map last parsed.
        If no tile renderable_map has yet been parsed the version will read 0, 0
        */
        const Version& getVersion() const { return m_version; }

        /*!
        \brief Returns the orientation of the renderable_map if one is loaded,
        else returns None
        */
        Orientation getOrientation() const { return m_orientation; }

        /*!
        \brief Returns the RenderOrder of the renderable_map if one is loaded,
        else returns None
        */
        RenderOrder getRenderOrder() const { return m_renderOrder; }

        /*!
        \brief Returns the tile count of the renderable_map in the X and Y directions
        */
        const Vector2u& getTileCount() const { return m_tileCount; }

        /*!
        \brief Returns the size of the tile grid in this renderable_map.
        ...
        */
        ...
        /*!
        \brief Returns the bounds of the renderable_map
        */
        ...
        renderable_map is loaded.
        The length returned is in pixels of the straight edge running
        along the axis returned by getStaggerAxis(). If no renderable_map is loaded
        or the loaded renderable_map is not of Hexagonal orientation this function
        returns 0.f
        */
        float getHexSideLength() const { return m_hexSideLength; }

        /*!
        \brief Stagger axis of the renderable_map.
        If either a Staggered or Hexagonal tile renderable_map is loaded this returns
        which axis the renderable_map is staggered along, else returns None.
        */
        StaggerAxis getStaggerAxis() const { return m_staggerAxis; }

        /*!
        \brief Stagger Index of the loaded renderable_map.
        If a Staggered or Hexagonal renderable_map is loaded this returns whether
        ...
        */
        ...
        /*!
        \brief Returns the background colour of the renderable_map.
        */
        const Colour& getBackgroundColour() const { return m_backgroundColour; }

        /*!
        \brief Returns a reference to the vector of tile sets used by the renderable_map
        */
        ...
        */
        ...
        /*!
        \brief Returns a vector of Property objects loaded by the renderable_map
        */
        ...
        */
        ...
        /*!
        \brief Returns the current working directory of the renderable_map. Images and
        ...
        */
        ...
        from this renderable_map. Otherwise the object's tileset can be found from in the renderable_map's
        ...
        */
        ...
        /*!
        \brief Returns true if this is in infinite tile renderable_map.
        Infinite maps store their tile data in for tile layers in chunks. If
        this is an infinite renderable_map use TileLayer::getChunks() to get tile IDs
