    ...
    */
    ...
    public:
        ...
        */
        ...
        /*!
        \brief Represents a chunk of tile data, if this is an infinite renderable_map
        */
        struct Chunk final
        {
        ...
        */
        ...
        If this is empty then the renderable_map is most likely infinite, in
        ...
        */
        ...
        if the renderable_map is set to infinite. This will be empty if the renderable_map
        is not infinite.
        \see getTiles()
        */
